        ...
        extends AdvancedBSTree<K,V>
{
            ...
            if ( lastStep.isLeftChild )
                switch ( parent.getBalance() )
                {
                    ...
                    case 'E':
                        ...
                        break;
                    case 'R':
                        deGrew = rebalanceRemRight(parent , path);
                        break;
                }
            else
                //remocao a direita
                ...
                {
                    case 'L':
                        deGrew = rebalanceRemLeft(parent , path);
                        break;
                    case 'E':
                        parent.setBalance('L');
                        deGrew = false;
    ...
    protected Boolean rebalanceRemLeft(AVLNode<K,V> node , Stack<PathStep<K,V>> path){
        ...
        switch (leftchild.getBalance()) {
            ...
            case 'L':
                ...
                break;
            case 'E':
                rotateLeft1E(node,leftchild,path);
                deGrew = false;
                break;
            case 'R':
                rotateLeft2(node,leftchild,path);
                break;
        }
        return deGrew;
    ...
    protected Boolean rebalanceRemRight(AVLNode<K,V> node , Stack<PathStep<K,V>> path) {
        ...
        switch (rightChild.getBalance()) {
            ...
            case 'L':
                rotateRight2(node,rightChild,path);
                break;
            case 'E':
                rotateRight1E(node , rightChild,path);
                deGrew = false;
                break;
            case 'R':
